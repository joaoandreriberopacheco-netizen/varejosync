...
const marker = `onChange={(value) => handleChange('unidades_alternativas', value)}
              />
            </div>
...
const block = `onChange={(value) => handleChange('unidades_alternativas', value)}
              />
            </div>
...
fs.writeFileSync(p, c.replace(marker, block));
console.log('ok');
