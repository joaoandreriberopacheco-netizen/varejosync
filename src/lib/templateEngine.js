...
export function prepararDadosVenda(pedido, dadosEmpresa) {
  ...
  return {
    ...
    empresa_nome_fantasia: (dadosEmpresa?.nome_fantasia || dadosEmpresa?.razao_social || 'VAREJOSYNC').toUpperCase(),
    empresa_razao_social: dadosEmpresa?.razao_social || '',
    tem_razao_social: !!(dadosEmpresa?.nome_fantasia && dadosEmpresa?.razao_social && dadosEmpresa.nome_fantasia !== dadosEmpresa.razao_social),
