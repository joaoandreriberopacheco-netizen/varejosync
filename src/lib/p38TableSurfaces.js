...
export const p38Table = {
  ...
  catalogMobileHeader:
    'border-t-2 border-t-[#4a5240] dark:border-t-[#a4ce33] border-b border-border/40 dark:border-white/10 bg-muted dark:bg-[#383e47] text-foreground shadow-[0_2px_10px_rgba(0,0,0,0.14)] dark:shadow-[0_4px_14px_rgba(0,0,0,0.45)]',
  catalogMobileHeaderPinned: 'fixed z-[60]',
