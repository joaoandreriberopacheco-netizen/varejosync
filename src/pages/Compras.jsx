...
import { ShoppingCart, PlusCircle, Search, Edit, Eye, User, Truck, DollarSign, CalendarRange, FileText } from 'lucide-react';
...
import GestaoEventosLogisticos from '../components/compras/GestaoEventosLogisticos';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-4 md:p-6">
      ...
      <Tabs defaultValue="sugestoes" className="space-y-6">
        ...
        <TabsContent value="eventos" className="outline-none animate-in fade-in-50 duration-300">
          <GestaoEventosLogisticos />
        </TabsContent>
      </Tabs>
    </div>
  );
