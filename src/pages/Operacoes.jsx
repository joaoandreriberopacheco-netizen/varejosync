  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="pb-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Logística, vendas e compras</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <Link to={createPageUrl('ItinerarioFluvial')}>
          <div className="p-6 border border-gray-200 dark:border-gray-700 rounded hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer">
            <Ship className="w-8 h-8 text-gray-700 dark:text-gray-400 mb-3" />
            <h3 className="text-base font-normal text-gray-800 dark:text-gray-200 mb-1">Boats</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Itinerário fluvial e logística</p>
          </div>
        </Link>
