    ...
    <>
      <div className="w-full flex items-stretch group">
        ...
        >
          ...
          <span className="flex-1 min-w-0 grid grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] lg:grid-cols-[minmax(0,1.8fr)_minmax(0,1.1fr)] gap-x-5 gap-y-2 items-start">
            ...
            <span className="min-w-0 flex flex-col items-start lg:items-end gap-2.5">
