      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            <div className="bg-transparent grid grid-cols-2 gap-3 md:gap-4">
              ...
              size="lg" className="bg-neutral-100 rounded-md pdv-button-static border-0 h-14 md:h-20 flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2">
