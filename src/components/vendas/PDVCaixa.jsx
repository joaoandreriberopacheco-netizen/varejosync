      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            <div className="bg-transparent grid grid-cols-2 gap-3 md:gap-4">
              ...
              size="lg"
              className="bg-gray-50 text-gray-700 border-0 dark:bg-gray-800 dark:text-gray-100 h-14 md:h-20 flex-col md:flex-row gap-1 md:gap-2 pointer-events-auto cursor-pointer">
