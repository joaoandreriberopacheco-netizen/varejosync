...
/** Superfície operacional — busca, KPIs, botões de ação (mesma cor em todo o Financeiro). */
export const P38_FIELD_SURFACE = 'p38-search-field border-0 shadow-none';
export const P38_SEARCH = `${P38_FIELD_SURFACE} focus-visible:ring-1 focus-visible:ring-border/60`;
