  ...
  return (
    <div className="space-y-2.5">
      <div className="grid grid-cols-2 gap-2.5">
        <div className="bg-white dark:bg-slate-900 p-4 rounded-[24px] shadow-sm border border-gray-100/60 dark:border-white/5">
          <div className="flex items-center gap-1.5 mb-2">
            <TrendingUp className="w-3 h-3 text-green-500" />
            <p className="text-[9px] uppercase tracking-wider text-gray-500 dark:text-gray-400">Receitas</p>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-[24px] shadow-sm border border-gray-100/60 dark:border-white/5">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <p className="text-[9px] uppercase tracking-wider text-gray-500 dark:text-gray-400">Despesas</p>
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 px-4 py-4 rounded-[24px] shadow-sm border border-gray-100/60 dark:border-white/5">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-[9px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-0.5">Saldo de Execução</p>
