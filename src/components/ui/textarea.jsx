...
const Textarea = React.forwardRef(({ className, autoComplete, autoCapitalize, onChange, autoFocus, ...props }, ref) => {
  ...
  return (
    <textarea
      className={cn(
        "p38-data-uppercase flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:font-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      ref={ref}
      {...props}
