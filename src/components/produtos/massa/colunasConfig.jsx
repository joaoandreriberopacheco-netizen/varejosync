...
const EMB_SLOT_META = [
  {
    ...
    fatorLabel: 'Base fator',
    siglaAlt: ['Emb.1 Sigla'],
    fatorAlt: ['Emb.1 Fator'],
  },
  {
    siglaLabel: 'Alt.1 sigla',
    fatorLabel: 'Alt.1 fator',
    siglaAlt: ['Emb.2 Sigla'],
    fatorAlt: ['Emb.2 Fator'],
  },
  {
    siglaLabel: 'Alt.2 sigla',
    fatorLabel: 'Alt.2 fator',
    siglaAlt: ['Emb.3 Sigla'],
    fatorAlt: ['Emb.3 Fator'],
  },
];
...
/** ID, referência, Base + Alt.1–2 (sigla/fator) e unidade vitrine. */
export const COLUNAS_SOMENTE_EMBALAGENS = [
  ...
  ...EMB_SLOT_COLS,
  {
    ...
    altLabels: ['Unidade comercial (sigla)', 'Unidade Vitrine'],
    editavel: true,
    width: 22,
    tipo: 'string',
  },
