  ...
  return (
    <div className="bg-card rounded-3xl p-5 shadow-sm space-y-3">
      <div>
        ...
        <h3 className="mt-1 text-lg font-semibold text-foreground dark:text-foreground font-glacial">{evento.transportadora_nome || evento.embarcacao_nome}</h3>
      ...
      <div className="rounded-2xl bg-muted/40 dark:bg-muted p-3 shadow-sm">
        ...
        <div className="mt-2 text-sm text-foreground dark:text-foreground flex items-center gap-2"><ShipWheel className="w-4 h-4" /> ETA: {evento.data_chegada_destino_formatada || '-'}</div>
        <div className="text-xs text-muted-foreground mt-1">Código: {evento.codigo || '-'}</div>
        <div className="mt-2 text-sm text-foreground dark:text-foreground">Chegada em Manaus: {evento.data_chegada_manaus_formatada || '-'}</div>
      ...
      <div className="rounded-2xl bg-muted/40 dark:bg-muted p-3 shadow-sm">
        ...
        <div className="mt-2 text-sm text-foreground dark:text-foreground">{evento.ocupacao_percentual_dinamica || 0}% da capacidade</div>
